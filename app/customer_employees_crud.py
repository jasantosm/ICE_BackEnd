...
def get_employees_by_customer(db: Session, customer_id: int):
    return db.query(models.CustomerEmployee).filter(models.CustomerEmployee.customer_id==customer_id).all()
